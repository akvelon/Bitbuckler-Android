...
import com.akvelon.bitbuckler.databinding.ItemRepositorySearchResultBinding
...
class RepositoryListSearchResultAdapter(
    ...
    companion object {
        ...
        const val CALCULATED_ITEM_HEIGHT = 72
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        when (viewType) {
            ITEM_VIEW_TYPE -> RepositoryHolder(parent.inflate(R.layout.item_repository_search_result))
    ...
    inner class RepositoryHolder(itemView: View) : BaseViewHolder(itemView) {
        private val binding by viewBinding(ItemRepositorySearchResultBinding::bind)

        init {
            itemView.setOnClickListener {
                clickListener(items[bindingAdapterPosition] as Repository)
            }
        }
